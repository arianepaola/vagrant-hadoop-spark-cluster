...
JAVA_ARCHIVE=jdk-8u71-linux-i586.tar.gz
...
#flink
FLINK_VERSION=flink-$FLINK_VERSION
FLINK_ARCHIVE=$FLINK_VERSION-bin-hadoop$FLINK_HADOOP_VERSION.tgz
FLINK_MIRROR_DOWNLOAD=../resources/$FLINK_ARCHIVE
#ssh
